  ...
  return (
    <div className="alarm-overlay" onClick={onClose}>
      <div className="alarm-panel" onClick={e => e.stopPropagation()}>
        ...
        {/* Alarm count badge */}
        <div className="alarm-panel-badge" style={{ color: accentColor, background: accentBg }}>
        ...
        <ul className="alarm-list">
          {hasAlarm ? (
            <li className="alarm-entry">
              <span className="alarm-entry-dot" style={{ background: accentColor }} />
              <div className="alarm-entry-body">
                <span className="alarm-entry-name">Temperature Exceeded</span>
                <span className="alarm-entry-time">Today, 10:42 AM</span>
              </div>
            </li>
          ) : (
...
export default function Dashboard({ onLogout }) {
  ...
  const [devices, setDevices] = useState([
    { id: 1, name: 'BlueLite 1', serialNumber: '12345678', version: '5.17', sampleRate: '1 sec', battery: '50%', temperature: '24.2°c', humidity: '38%', isRunning: true, alarmCount: 1, hasAlarm: true },
    { id: 2, name: 'DataNet23', serialNumber: '87654321', version: '5.17', sampleRate: '1 sec', battery: '80%', temperature: '22.0°c', humidity: '40%', isRunning: false, alarmCount: 0, hasAlarm: false },
  ])
